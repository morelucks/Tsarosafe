    ...
    <nav className="w-full bg-[#0a192f] border-b border-white/10 sticky top-0 z-[100] h-20 flex items-center">
      <div className="max-w-7xl mx-auto w-full px-4 sm:px-6 flex justify-between items-center">
        ...
        <div className="flex items-center gap-2 sm:gap-3 md:gap-6 flex-shrink-0">
          ...
          {mounted && isMiniPay ? (
            isConnected ? (
              <div className="flex-shrink-0 flex items-center gap-1.5 sm:gap-2 bg-gradient-to-r from-amber-500/10 to-yellow-500/10 border border-yellow-500/20 px-2 py-1 sm:px-3 sm:py-1.5 md:px-3.5 md:py-2 rounded-lg text-yellow-500 font-mono text-[10px] sm:text-xs shadow-[0_0_15px_rgba(234,179,8,0.05)] whitespace-nowrap">
              ...
              <div className="flex-shrink-0 bg-yellow-500/10 text-yellow-500 border border-yellow-500/20 px-2 py-1 sm:px-3 sm:py-1.5 md:px-4 md:py-2 rounded-lg text-[10px] sm:text-xs font-bold tracking-widest uppercase animate-pulse whitespace-nowrap">
